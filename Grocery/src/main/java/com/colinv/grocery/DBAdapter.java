...
public class DBAdapter {
    ...
    static final String DATABASE_CREATE = "create table items (_id integer primary key autoincrement, " + "name text not null);";
    ...
    {
        return db.query(DATABASE_TABLE, new String[]{KEY_ROWID, KEY_NAME}, null, null, null, null,null,null);
    }
    ...
    //---update an item---
    public boolean updateItem(long rowId, String name)
    {
